...
insert into item (precio_venta, cantidad_item, id_producto, id_entrada) values (3000, 3, 1, 1);
...
insert into usuario (nombres_usuario, apellidos_usuario, tipo_documento, numero_documento_usuario, usuario, contraseña, telefono_usuario, rol_usuario) values ("Ana", "López", 3, 55555555, "ana555", "123456ana", 555555555, "empleado");
